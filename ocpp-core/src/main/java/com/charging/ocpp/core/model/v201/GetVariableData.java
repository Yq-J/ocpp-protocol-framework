...
/**
 * OCPP 2.0.1 的 GetVariableData 复合协议实体类。
 * <p>
 * 用途：描述Get变量数据相关的结构化数据，作为 OCPP 2.0.1 请求或响应 payload 中的嵌套对象复用。
...
public class GetVariableData {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 GetVariableData 协议对象中传递厂商自定义扩展数据。
     ...
     * 属性类型。
     * <p>
     * 用途：对应 OCPP 字段 {@code attributeType}，在 OCPP 2.0.1 GetVariableData 协议对象中传递属性类型。
     ...
     * 设备组件。
     * <p>
     * 用途：对应 OCPP 字段 {@code component}，在 OCPP 2.0.1 GetVariableData 协议对象中传递设备组件。
     ...
     * 设备变量。
     * <p>
     * 用途：对应 OCPP 字段 {@code variable}，在 OCPP 2.0.1 GetVariableData 协议对象中传递设备变量。
