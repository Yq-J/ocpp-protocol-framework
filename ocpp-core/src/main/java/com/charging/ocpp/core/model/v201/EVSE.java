...
/**
 * OCPP 2.0.1 的 EVSE 复合协议实体类。
 * <p>
 * 描述充电站中的 EVSE 及其连接器定位信息。
...
public class EVSE {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 EVSE 协议对象中传递厂商自定义扩展数据。
     ...
     * 对象标识。
     * <p>
     * 用途：对应 OCPP 字段 {@code id}，在 OCPP 2.0.1 EVSE 协议对象中传递对象标识。
     ...
     * 连接器编号。
     * <p>
     * 用途：对应 OCPP 字段 {@code connectorId}，在 OCPP 2.0.1 EVSE 协议对象中传递连接器编号。
