...
/**
 * OCPP 2.0.1 的 UnpublishFirmware 响应 payload 协议实体类。
 * <p>
 * 用途：承载 UnpublishFirmware 操作的响应字段，用于取消发布固件场景下的 OCPP CALL/CALLRESULT payload 序列化与反序列化。
...
public class UnpublishFirmwareResponse {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 UnpublishFirmwareResponse 协议对象中传递厂商自定义扩展数据。
