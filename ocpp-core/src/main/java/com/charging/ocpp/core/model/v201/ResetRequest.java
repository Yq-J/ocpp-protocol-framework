...
/**
 * OCPP 2.0.1 的 Reset 请求 payload 协议实体类。
 * <p>
...
public class ResetRequest {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 ResetRequest 协议对象中传递厂商自定义扩展数据。
     ...
     * 类型。
     * <p>
     * 用途：对应 OCPP 字段 {@code type}，在 OCPP 2.0.1 ResetRequest 协议对象中传递类型。
     ...
     * EVSE 编号。
     * <p>
     * 用途：对应 OCPP 字段 {@code evseId}，在 OCPP 2.0.1 ResetRequest 协议对象中传递EVSE 编号。
