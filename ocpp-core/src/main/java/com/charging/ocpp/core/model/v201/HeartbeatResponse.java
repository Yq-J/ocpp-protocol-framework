...
/**
 * OCPP 2.0.1 的 Heartbeat 响应 payload 协议实体类。
 * <p>
...
public class HeartbeatResponse {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 HeartbeatResponse 协议对象中传递厂商自定义扩展数据。
     ...
     * 当前时间。
     * <p>
     * 用途：对应 OCPP 字段 {@code currentTime}，在 OCPP 2.0.1 HeartbeatResponse 协议对象中传递当前时间。
