...
/**
 * OCPP 1.6J 的 DiagnosticsStatusNotification 请求 payload 协议实体类。
 * <p>
 * 用途：承载 DiagnosticsStatusNotification 操作的请求字段，用于上报诊断上传状态场景下的 OCPP CALL/CALLRESULT payload 序列化与反序列化。
