...
/**
 * OCPP 2.0.1 的 Modem 复合协议实体类。
 * <p>
 * 用途：描述Modem相关的结构化数据，作为 OCPP 2.0.1 请求或响应 payload 中的嵌套对象复用。
...
public class Modem {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 Modem 协议对象中传递厂商自定义扩展数据。
     ...
     * SIM 卡 ICCID。
     * <p>
     * 用途：对应 OCPP 字段 {@code iccid}，在 OCPP 2.0.1 Modem 协议对象中传递SIM 卡 ICCID。
     ...
     * SIM 卡 IMSI。
     * <p>
     * 用途：对应 OCPP 字段 {@code imsi}，在 OCPP 2.0.1 Modem 协议对象中传递SIM 卡 IMSI。
