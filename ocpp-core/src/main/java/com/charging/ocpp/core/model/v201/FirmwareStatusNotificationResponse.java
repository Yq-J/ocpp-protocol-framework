...
/**
 * OCPP 2.0.1 的 FirmwareStatusNotification 响应 payload 协议实体类。
 * <p>
...
public class FirmwareStatusNotificationResponse {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 FirmwareStatusNotificationResponse 协议对象中传递厂商自定义扩展数据。
