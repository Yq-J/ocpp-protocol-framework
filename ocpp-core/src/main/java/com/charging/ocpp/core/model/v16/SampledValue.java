...
/**
 * OCPP 1.6J 的 SampledValue 复合协议实体类。
 * <p>
...
public class SampledValue {
     ...
     * 字段值。
     * <p>
     * 用途：对应 OCPP 字段 {@code value}，在 OCPP 1.6J SampledValue 协议对象中传递字段值。
     ...
     * 读数上下文。
     * <p>
     * 用途：对应 OCPP 字段 {@code context}，在 OCPP 1.6J SampledValue 协议对象中传递读数上下文。
     ...
     * 数据格式。
     * <p>
     * 用途：对应 OCPP 字段 {@code format}，在 OCPP 1.6J SampledValue 协议对象中传递数据格式。
     ...
     * 计量量类型。
     * <p>
     * 用途：对应 OCPP 字段 {@code measurand}，在 OCPP 1.6J SampledValue 协议对象中传递计量量类型。
     ...
     * 相位。
     * <p>
     * 用途：对应 OCPP 字段 {@code phase}，在 OCPP 1.6J SampledValue 协议对象中传递相位。
     ...
     * 位置。
     * <p>
     * 用途：对应 OCPP 字段 {@code location}，在 OCPP 1.6J SampledValue 协议对象中传递位置。
     ...
     * 计量单位。
     * <p>
     * 用途：对应 OCPP 字段 {@code unit}，在 OCPP 1.6J SampledValue 协议对象中传递计量单位。
