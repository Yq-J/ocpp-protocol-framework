...
/**
 * OCPP 2.0.1 的 SendLocalList 响应 payload 协议实体类。
 * <p>
...
public class SendLocalListResponse {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 SendLocalListResponse 协议对象中传递厂商自定义扩展数据。
     ...
     * 状态补充信息。
     * <p>
     * 用途：对应 OCPP 字段 {@code statusInfo}，在 OCPP 2.0.1 SendLocalListResponse 协议对象中传递状态补充信息。
