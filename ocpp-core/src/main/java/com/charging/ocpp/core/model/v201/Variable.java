...
public class Variable {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 Variable 协议对象中传递厂商自定义扩展数据。
     ...
     * 名称。
     * <p>
     * 用途：对应 OCPP 字段 {@code name}，在 OCPP 2.0.1 Variable 协议对象中传递名称。
     ...
     * 实例名称。
     * <p>
     * 用途：对应 OCPP 字段 {@code instance}，在 OCPP 2.0.1 Variable 协议对象中传递实例名称。
