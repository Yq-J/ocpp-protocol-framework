...
/**
 * OCPP 2.0.1 的 ClearMonitoringResult 复合协议实体类。
 * <p>
 * 用途：描述清除监控结果相关的结构化数据，作为 OCPP 2.0.1 请求或响应 payload 中的嵌套对象复用。
...
public class ClearMonitoringResult {
     ...
     * 厂商自定义扩展数据。
     * <p>
     * 用途：对应 OCPP 字段 {@code customData}，在 OCPP 2.0.1 ClearMonitoringResult 协议对象中传递厂商自定义扩展数据。
     ...
     * 处理状态。
     * <p>
     * 用途：对应 OCPP 字段 {@code status}，在 OCPP 2.0.1 ClearMonitoringResult 协议对象中传递处理状态。
     ...
     * 对象标识。
     * <p>
     * 用途：对应 OCPP 字段 {@code id}，在 OCPP 2.0.1 ClearMonitoringResult 协议对象中传递对象标识。
     ...
     * 状态补充信息。
     * <p>
     * 用途：对应 OCPP 字段 {@code statusInfo}，在 OCPP 2.0.1 ClearMonitoringResult 协议对象中传递状态补充信息。
