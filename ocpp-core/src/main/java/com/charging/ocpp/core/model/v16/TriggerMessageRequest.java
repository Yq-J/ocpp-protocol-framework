...
/**
 * OCPP 1.6J 的 TriggerMessage 请求 payload 协议实体类。
 * <p>
...
public class TriggerMessageRequest {
     ...
     * requested消息。
     * <p>
     * 用途：对应 OCPP 字段 {@code requestedMessage}，在 OCPP 1.6J TriggerMessageRequest 协议对象中传递requested消息。
     ...
     * 连接器编号。
     * <p>
     * 用途：对应 OCPP 字段 {@code connectorId}，在 OCPP 1.6J TriggerMessageRequest 协议对象中传递连接器编号。
